...
<link rel="stylesheet" href="${contextPath }css/fsblog.css">
...
<script src="${contextPath }util/simditor/scripts/module.js"></script>
<script src="${contextPath }util/simditor/scripts/uploader.js"></script>
<script src="${contextPath }util/simditor/scripts/hotkeys.js"></script>
<script src="${contextPath }util/simditor/scripts/simditor.js"></script>